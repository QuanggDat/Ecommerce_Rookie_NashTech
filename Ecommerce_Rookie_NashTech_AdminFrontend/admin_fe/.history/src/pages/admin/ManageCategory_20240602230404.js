      ...
      <table className="table-auto">
        <thead>
          <tr className="border bg-sky-900 text-white border-white">
            ...
            <th className="text-center py-2">Quantity Product</th>
        ...
        <tbody>
          <tr className="border-b" >
            ...
            <td className="text-center py-2">
              <img
                src='https://th.bing.com/th/id/OIP.RtMBGNvzot2YJU70O0stYgHaHa?rs=1&pid=ImgDetMain'
                alt="thumb"
            ...
            <td className="text-center py-2">20/06/2024</td>
            <td className="text-center py-2">20/06/2024</td>
            <td className="text-center py-2">
              Delete
            </td>
